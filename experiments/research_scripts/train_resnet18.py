# ============================================================
# PHASE 4E — RESNET18 (Stage 1 - Frozen Backbone)
# CPU Safe | Controlled Evaluation
# ============================================================
...
from legacy_imports_compat import PneumoniaDataset, get_resnet18
...
def main():
    ...
    model = get_resnet18(num_classes=3, freeze=True)
